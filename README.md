...
| **[Agent Coordinator](https://github.com/alanhoff/agent-coordinator)** | Per-user Codex skill for bounded work graphs, revisioned local state, reconciliation before retry, and optional specialists or inline execution. | **Open Source** | **Free:** MIT-licensed. |
