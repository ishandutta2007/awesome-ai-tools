...
| **YYLO** | command-line orchestrator for coding agents with typed task, validation, merge, and release-readiness boundaries in a dedicated branch/worktree ([GitHub](https://github.com/yylo-dev/yylo)). | **Open Source** | **Free:** Open-source. Pay for your own LLM API (BYOK). |
...
| Tool | Description | Company Size | Pricing & Free Tier |
| :--- | :--- | :--- | :--- |
| **Kling 2.0** | best Chinese video model | **$25B** (Kuaishou) | **Free:** 66 daily credits. **Standard:** $10/mo. |
...
| Model | Description | Company Size | Availability / Pricing |
| :--- | :--- | :--- | :--- |
| **Gemma 3** | Google's latest open models | **$4.0T** (Google) | **Free:** Open Weights (Gemma Terms). |
| **Phi-4 / Phi-4-mini** | Microsoft's small language models | **$3.5T** (Microsoft) | **Free:** Open Weights (MIT). |
| **Llama 4 / Llama 3.3 / Llama 3.1 405B** | Meta's state-of-the-art open models | **$1.46T** (Meta) | **Free:** Open Weights (Llama License). |
